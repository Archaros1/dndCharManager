    ...
    <div class="container">
        <div class="col">
            ...
            <div class="row mb-4" id="classes">
                {{ Form::label('hitdice', 'Résultat du dé à '.$investment->class->hitdice.' faces', $attributes = ['class' => 'control-label mr-1']) }}
                <img src="{{ asset('/icons/dices.svg') }}" alt="" id="rollHitDice" class=" size-icon" title="Roll the dice">
