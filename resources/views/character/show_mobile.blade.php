    ...
    <div class="container">
        ...
        <div class="row size-text-5 font-weight-bold mt-2">
            <div class="col-4 border border-str">
                ...
                <div class="row">
                    <div class="col statFlat">{{ $character->statPack()->strength }}</div>
                </div>
            </div>
            <div class="col-4 border border-dex">
                ...
                <div class="row">
                    <div class="col statFlat">{{ $character->statPack()->dexterity }}</div>
                </div>
            </div>
            <div class="col-4 border border-con">
                ...
                <div class="row">
                    <div class="col statFlat">{{ $character->statPack()->constitution }}</div>
                </div>
            </div>
            <div class="col-4 border border-int">
                ...
                <div class="row">
                    <div class="col statFlat">{{ $character->statPack()->intelligence }}</div>
                </div>
            </div>
            <div class="col-4 border border-wis">
                ...
                <div class="row">
                    <div class="col statFlat">{{ $character->statPack()->wisdom }}</div>
                </div>
            </div>
            <div class="col-4 border border-cha">
                ...
                <div class="row">
                    <div class="col statFlat">{{ $character->statPack()->charisma }}</div>
                </div>
            </div>
