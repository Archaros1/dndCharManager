    ...
    <div class="container">
        <div class="col">
            ...
            <div class="row mb-4">
                ...
                {{ Form::text('name', $value = null, $attributes = ['class' => 'form-control', 'required' => null]) }}
            </div>
            <div class="row mb-4">
                {{ Form::label('level', 'Niveau', $attributes = ['class' => 'control-label mr-3']) }}
                {{ Form::selectRange('level', 1, 20, $attributes = ['class' => 'form-control mr-4', 'required' => null]) }}
            </div>
            <div class="row mb-4">
                {{ Form::label('race', 'Race', $attributes = ['class' => 'control-label mr-3']) }}
                {{ Form::select('race', $races, $attributes = ['class' => 'form-control', 'required' => null]) }}
            </div>
            <div class="row mb-4">
